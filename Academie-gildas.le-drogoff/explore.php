...
require __DIR__ . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'HashtagsController.php';
//var_dump($_POST);
?>
<!Doctype html>
<html lang="en">
        ...
        <div class="container mt-4">
          <form id="searchTags_form" method="post" action="explore.php">
            <div class="mb-3">
              ...
              <input name="searchTags_input" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>

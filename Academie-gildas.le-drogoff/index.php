<?php
session_unset();
require __DIR__ . DIRECTORY_SEPARATOR . 'app' . DIRECTORY_SEPARATOR . 'Controllers' . DIRECTORY_SEPARATOR . 'inscription.php';
...
<head>
  ...
  <?php
  require __DIR__ . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'favicon' . DIRECTORY_SEPARATOR . 'favicon.php';
  ?>
</head>
      ...
      <div class="col-6">
        <div class="container">
          ...
          <div class="pt-5 mb-3 mt-5">
            ...
            <button type="button" class="btn btn-danger rounded-pill w-50 p-2" data-bs-toggle="modal" data-bs-target="#signUp">Sign up
            </button>
            <!-- Modal -->
                    ...
                    <div id="form">
                      ...
                      <form action="register.php" method="POST">
                        ...
                        <div class="form-floating mb-3">
                          <input type="text" name="name" required class="form-control" placeholder="mlkj@mlkj.com" id="signupCountChar" maxlength="50">
                          <label for="floatingInput">Name <span id="char"></span></label>
                        </div>
                        <div class="form-floating mb-3" id="mail">
                          <input type="email" name="email" required class="form-control" placeholder="mlkj@mlkj.com" id="floatingInput" maxlength="50">
                          <label for="floatingInput">Email</label>
                        </div>
                        <div class="form-floating mb-3">

                          <input name="mdp" password-toggle type="password" class="form-control" placeholder="mlkj@mlkj.com" required>
                          <div class="form-check">
                            <input class="form-check-input toggleVisibility" type="checkbox" checked style="float: left!important; margin-top: 1em;">
          ...
          <div class="login-but mt-3">
            <!-- Button trigger modal -->
            <button type="button" class="btn btn-black btn-outline-light rounded-pill w-50 p-2" data-bs-toggle="modal" data-bs-target="#logIn">Log in
            </button>
            <!-- Modal -->
                  ...
                  <div class="modal-body">
                    <div id="form">
                      ...
                      <form action="login.php" method="POST">
                        ...
                        <br>
                        <div class="form-floating mb-3" id="mail">
                          <input type="email" name="email" required class="form-control" id="floatingInput" placeholder="mlkj@mlkj.com" maxlength="50">
                          <label for="floatingInput">Email</label>
                        </div>
                        <div class="form-floating mb-3">

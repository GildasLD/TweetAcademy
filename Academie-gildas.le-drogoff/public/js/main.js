...
window.addEventListener("load", function () {
  ...
  exampleModal?.addEventListener("show.bs.modal", function (event) {
    ...
    function sendReply() {
      ...
      var message_text = exampleModal.querySelector("#message-text").value;
      let formData;
      ...
      message_content = new Request("https://gildas-le-drogoff.alwaysdata.net/academie/app/Controllers/ReplyController.php", {
        method: "POST",
        body: formData,
        headers: new Headers({}),
      });
...
function retweet() {
  ...
  tweet_id = new Request("https://gildas-le-drogoff.alwaysdata.net/academie/Received_tweets.php", {
    method: "POST",
    body: formData,
    headers: new Headers({}),
  });
...
send_messages_form?.addEventListener("submit", function (e) {
  ...
  let sendMessage = new Request("https://gildas-le-drogoff.alwaysdata.net/academie/app/Controllers/MessageControl.php", {
    method: "POST",
    body: formData,
    headers: new Headers({}),
  });
...
EditProfile_form?.addEventListener("submit", function (e) {
  ...
  let sendMessage = new Request("https://gildas-le-drogoff.alwaysdata.net/academie/app/Controllers/EditProfile.php", {
    method: "POST",
    body: formData,
    headers: new Headers({}),
  });
...
what_s_happenning?.addEventListener("submit", function (e) {
  ...
  !(function (data) {
    ...
    XHR.open("POST", "https://gildas-le-drogoff.alwaysdata.net/academie/Received_tweets.php");
    XHR.send(data);
